...
β2 = 0.6 # order of the derivative

X0 = 1.95  # initial condition
# .8435, 1.9568
...
P=plot(t[1:10:end], x1[1:10:end], color = myColor2[1], linewidth = 2, yaxis = "Population dynamics",
      labels = "X,      0", legendtitle = "Population, Memory", legendposition = :topleft, legendtitlefont = font(10))
plot!(t[1:10:end], x2[1:10:end], color = myColor2[2], xaxis = "Time",
      labels = "X,      0.4", linewidth = 2)


savefig(P, "BoosterUni.svg")