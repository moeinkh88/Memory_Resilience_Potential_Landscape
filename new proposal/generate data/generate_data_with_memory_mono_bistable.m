...
bbb=[.079, 1.3]; % define some values in monostable region
% bbb=.05; % define some values in monostable region
...
%%
save('herbivore_dynamics_memory8.mat','sol')
%% 
...
% write to CSV
writetable(tblAll,'herbivore_dynamics_memory8.csv')

fprintf('CSV written: %s (%d rows)\n', ...
        'herbivore_dynamics_memory8.csv',height(tblAll));
