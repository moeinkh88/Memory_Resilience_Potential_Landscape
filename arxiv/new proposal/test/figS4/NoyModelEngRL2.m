...
% perturbation
P=8; % P is strength of perturbation (B+p)
...
[Q1LM,Xall1LM,Q1RM,Xall1RM]=solveFDEM(par,al(2)); % Potential with perturbation right side
...
if r1>0 && r2>0 && isreal(r1) && isreal(r2)
    [Xall1,Q1]=PotenDepth(par,A, al(1)); % Potential without perturbation
else
    [Q1,Xall1]=solveFDE(par,A, al(1)); % Potential with perturbation
end
...
[Xall,Q]=PotenDepth(par,A,al(1)); % Potential without perturbation
[XallM,QM]=PotenDepth(par,A,al(2)); % Potential without perturbation
