...
anim = @animate for i = 1:20:length(t_vals)  # step to speed up animation
    ...
    scatter!(p1_left, ρ_unstable, A_unstable, label="", markersize=1, color=:red)
    ...
    scatter!(p1_right, ρ_unstable, A_unstable, label="", markersize=1, color=:red)
