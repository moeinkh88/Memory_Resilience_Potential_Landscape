...
load('Rdp.mat') % Depth in right valley
load('CurvR.mat') % Curvature in right valley
load('EcoRL.mat') % Resistance in right valley
load('EngRL.mat') % Resilience in right valley
load('Flat.mat') % Flatness in right valley
